...
```move title="crates/sui-framework/packages/sui-framework/sources/dynamic_field.move"
...
```move title="crates/sui-framework/packages/sui-framework/sources/dynamic_object_field.move"
...
```move title="examples/move/dynamic_fields/sources/example.move"
