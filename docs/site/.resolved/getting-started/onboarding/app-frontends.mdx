...
doc_goal:
  audience: Developers new to Sui with React experience
  outcome: Can implement wallet connection in their own app
  success_criteria:
    - Code examples are runnable as-is
    - Required dependencies are listed before use
    - Common errors (wrong provider order) are addressed
  non_goals:
    - Deep dive into wallet standards
    - Custom wallet adapter authoring
---
...
<!-- [external GitHub content: MystenLabs/sui-stack-hello-world//ui/src/App.tsx — fetch at runtime] -->
...
<!-- [external GitHub content: MystenLabs/sui-stack-hello-world//ui/src/CreateGreeting.tsx — fetch at runtime] -->
...
<!-- [external GitHub content: MystenLabs/sui-stack-hello-world//ui/src/Greeting.tsx — fetch at runtime] -->
...
<!-- [external GitHub content: MystenLabs/sui-stack-hello-world//ui/src/constants.ts — fetch at runtime] -->

The `networkConfig.ts` file uses this constant:

<!-- [external GitHub content: MystenLabs/sui-stack-hello-world//ui/src/networkConfig.ts — fetch at runtime] -->
