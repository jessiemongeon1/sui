...
<!-- [external GitHub content: MystenLabs/ts-sdks//packages/deepbook-v3/src/client.ts — fetch at runtime] -->
...
<!-- [external GitHub content: MystenLabs/ts-sdks//packages/deepbook-v3/src/transactions/deepbook.ts — fetch at runtime] -->
