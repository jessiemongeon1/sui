...
`<!-- [external GitHub content: MystenLabs/ts-sdks//packages/dapp-kit-next/packages/dapp-kit-core/src/core/index.ts — fetch at runtime] -->
...
<!-- [external GitHub content: MystenLabs/ts-sdks//packages/dapp-kit-next/packages/dapp-kit-react/src/components/DAppKitProvider.tsx — fetch at runtime] -->
...
<!-- [external GitHub content: MystenLabs/ts-sdks//packages/dapp-kit-next/packages/dapp-kit-react/src/hooks/useWalletConnection.ts — fetch at runtime] -->

<!-- [external GitHub content: MystenLabs/ts-sdks//packages/dapp-kit-next/packages/dapp-kit-react/src/hooks/useCurrentWallet.ts — fetch at runtime] -->

<!-- [external GitHub content: MystenLabs/ts-sdks//packages/dapp-kit-next/packages/dapp-kit-react/src/hooks/useCurrentAccount.ts — fetch at runtime] -->

### List available wallets

<!-- [external GitHub content: MystenLabs/ts-sdks//packages/dapp-kit-next/packages/dapp-kit-react/src/hooks/useWallets.ts — fetch at runtime] -->

### Sign and execute a transaction

<!-- [external GitHub content: MystenLabs/ts-sdks//packages/dapp-kit-next/packages/dapp-kit-react/src/hooks/useDAppKit.ts — fetch at runtime] -->
