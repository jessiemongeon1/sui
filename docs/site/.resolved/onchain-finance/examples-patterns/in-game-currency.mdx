...
<!-- [external GitHub content: MystenLabs/sui-move-bootcamp/I3/king_credits/sources/king_credits.move — fetch at runtime] -->
...
<!-- [external GitHub content: MystenLabs/sui-move-bootcamp/I3/king_credits/sources/crown_council_rule.move — fetch at runtime] -->
