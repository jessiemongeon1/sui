		...
		<tr>
			<td colspan={7}>
				<details>
					...
					```toml title="examples/prod-config/indexer/events.toml"
[pruner]
retention = 31104000
		...
		<tr>
			<td colspan={7}>
				<details>
					...
					```toml title="examples/prod-config/indexer/obj_versions.toml"
[ingestion]
		...
		<tr>
			<td colspan={7}>
				<details>
					...
					```toml title="examples/prod-config/indexer/tx_affected_addresses.toml"
[ingestion]
ingest-concurrency = { kind = "fixed", value = 20 }
		...
		<tr>
			<td colspan={7}>
				<details>
					...
					```toml title="examples/prod-config/indexer/tx_affected_objects.toml"
[committer]
		...
		<tr>
			<td colspan={7}>
				<details>
					...
					```toml title="examples/prod-config/indexer/tx_calls.toml"
[committer]
write-concurrency = 10
		...
		<tr>
			<td colspan={7}>
				<details>
					...
					```toml title="examples/prod-config/indexer/tx_kinds.toml"
[pruner]
retention = 31104000
		...
		<tr>
			<td colspan={7}>
				<details>
					...
					```toml title="examples/prod-config/indexer/unpruned.toml"
[ingestion]
ingest-concurrency = { kind = "fixed", value = 20 }
...
<details>
	...
	```toml title="examples/prod-config/consistent_store.toml"
[ingestion]
ingest-concurrency = { kind = "fixed", value = 20 }
...
<details>
	...
	```toml title="examples/prod-config/graphql.toml"
[limits]
