...
```sql title="examples/rust/walrus-attributes-indexer/migrations/YYYY-MM-DD-HHMMSS_blog-post/up.sql"
...
```rust title="examples/rust/walrus-attributes-indexer/src/handlers/blog_post.rs"
...
```rust title="examples/rust/walrus-attributes-indexer/src/main.rs"
#[tokio::main]
