...
doc_goal:
  audience: Developers who completed the getting-started onboarding and want to go deeper
  outcome: Can identify their next learning path and connect with the Sui developer community
  success_criteria:
    - At least 3 distinct next-step paths are presented (e.g., Move deep dive, SDK, community)
    - Every resource link resolves to the correct destination
    - Verification checklist confirms the reader completed all onboarding prerequisites
  non_goals:
    - Detailed tutorials for any next-step topic
    - Project ideation or architecture guidance
---
