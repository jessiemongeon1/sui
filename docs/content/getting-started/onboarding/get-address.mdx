...
doc_goal:
  audience: Developers new to Sui who need an onchain identity to start building
  outcome: Can create a Sui address and understand how to secure and recover it
  success_criteria:
    - Reader can generate a new address and verify it via CLI in under 3 minutes
    - Recovery phrase security guidance is prominent and actionable
    - All supported key schemes (ed25519, secp256k1, secp256r1) are listed with usage context
  non_goals:
    - Multi-sig address setup
