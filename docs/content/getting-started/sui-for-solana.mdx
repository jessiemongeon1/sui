---
title: Solana -> Sui
description: Build your first app on Sui if you have Solana experience
keywords: [ solana, rust, anchor ]
pagination_prev: null
doc_goal:
  audience: Solana/Rust developers exploring Sui for the first time
  outcome: Can map core Solana concepts (accounts, programs, PDAs, CPIs) to their Sui/Move equivalents
  success_criteria:
    - Every comparison row in the table links to a deeper resource for the Sui side
    - Reader can identify the Move equivalent for at least 5 key Solana patterns
    - Code examples compile and run against the current Sui framework version
  non_goals:
    - Complete Move language tutorial
    - Anchor-to-Move code migration tooling
---
