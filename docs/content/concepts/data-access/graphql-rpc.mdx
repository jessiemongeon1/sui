...
{
<<<<<<< HEAD:docs/content/concepts/data-access/graphql-rpc.mdx
	serviceConfig {
...
>>>>>>> e7e9c9b317 (Remove Sui Essentials and Advanced categories):docs/content/guides/developer/accessing-data/graphql-rpc.mdx
